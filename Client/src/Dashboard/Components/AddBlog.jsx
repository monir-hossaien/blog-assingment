...
const AddBlog = () => {
    ...
    return (
        <section className="rounded-md shadow w-[50%] p-6 mx-auto">
            ...
            <form>
                <div className="grid grid-rows-1 gap-6 mt-4 sm:grid-cols-1">
                    <div>
                ...
                <div className="flex justify-end mt-6">
                    <Button onClick={()=> handleFormSubmit()} className=" w-40 px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600"
                    text="Save"
                    />
